...
git rm -r staging production scripts/copy-branch-to-main.sh scripts/reset-all-branches-to-main.sh
...
git rm -r production scripts scripts/copy-branch-to-main.sh scripts/reset-all-branches-to-main.sh
find ./ -type f -name '*lock*' | xargs git rm
...
git rm -r development scripts scripts/copy-branch-to-main.sh scripts/reset-all-branches-to-main.sh
find ./ -type f -name '*lock*' | xargs git rm
