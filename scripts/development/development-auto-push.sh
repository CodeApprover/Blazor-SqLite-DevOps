...
case $# in
    ...
    ;;
    *)
        echo "Error: Invalid number of arguments. Expected 0, 1, or 2 arguments, but got $#."
        echo "Usage:"
        echo "$0                       # Use default values"
        echo "$0 [num_commits]        # Specify number of commits"
        echo "$0 [num_commits] [wait_duration]   # Specify number of commits and wait duration in seconds"
        exit 1
    ;;
esac
