...
- Any unmerged changes in deleted branches will be LOST FOREVER.
- The deleted branches on the remote could impact other collaborators' work.
- The operations are irreversible. Ensure you have a backup if needed.
- All stashes will be dropped and lost.
